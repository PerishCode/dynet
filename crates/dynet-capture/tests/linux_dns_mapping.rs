use dynet_capture::{DnsMappingOptions, LinuxTakeover};
...
fn mapping_apply_dual_stack() {
    ...
    for command in [
        "nft add rule inet dynet dynet_dns_mapping iifname \"br-lan\" meta nfproto ipv4 udp dport 53 redirect to :1053",
        "nft add rule inet dynet dynet_dns_mapping iifname \"br-lan\" meta nfproto ipv4 tcp dport 53 redirect to :1053",
        "nft add rule inet dynet dynet_dns_mapping iifname \"br-lan\" meta nfproto ipv6 udp dport 53 redirect to :1053",
        "nft add rule inet dynet dynet_dns_mapping iifname \"br-lan\" meta nfproto ipv6 tcp dport 53 redirect to :1053",
    ] {
