...
pub use context::{InboundContext, QualityScope, Transport};
...
pub use plan::{
    ...
    DialerOutboundPayload, OutboundCandidate, OutboundCandidateQuality,
    OutboundCandidateQualityMatch, OutboundDecision, OutboundHop, OutboundPath, OutboundSelector,
    OutboundStrategyCapability, OutboundStrategyConfig, OutboundStrategyRegistry,
...
pub use state::{
    AppState, OutboundQualityEntry, OutboundQualityPlannerFeedback, OutboundQualitySignal,
