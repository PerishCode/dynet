...
impl<IO> std::fmt::Debug for VisionStream<IO> {
    fn fmt(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        formatter
            .debug_struct("VisionStream")
            .field("read_mode", &self.read_mode)
            .field("write_mode", &self.write_mode)
            .field("write_first_packet", &self.write_first_packet)
            .field("vless_response_pending", &self.vless_response_pending)
