...
def main() -> None:
    ...
    require_path("scripts/cli/vmctl.py")
    require_path("scripts/vm/ops/capture.py")
    require_path("scripts/vm/ops/check.py")
    require_path("scripts/vm/ops/cleanup.py")
    require_path("scripts/vm/ops/collect.py")
    require_path("scripts/vm/ops/dev.py")
